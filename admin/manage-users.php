...
//fetch users from database not current user
...
<section class="dashboard">
    ...
    <div class="container dashboard__container">
        <button id="show__side-btn" class="sidebar__toggle"><i class="uil uil-angle-right-b"></i></button>
        <button id="hide__side-btn" class="sidebar__toggle"><i class="uil uil-angle-left-b"></i></button>
